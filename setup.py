...
try:
    ...
    ghash_arg = "-DCELMECHGITHASH=6a225e5abe5b082b795ba477411a21fe25c4a610" #GITHASHAUTOUPDATE
...
setup(name='celmech',
    ...
    packages=['celmech'],
    install_requires=['mpmath>=1.0.0', 'sympy>=1.1.1', 'rebound>=3.5.11', 'reboundx>=3.0.4', 'numpy', 'scipy==1.2.0'],
    tests_require=['mpmath>=1.0.0', 'sympy>=1.1.1', 'rebound>=3.5.11', 'reboundx>=3.0.4', 'numpy', 'scipy==1.2.0'],
