...
if not os.getenv('READTHEDOCS'):
    packages = ['exoplanet-core==0.3.0rc2','pytensor' ,'sympy>=1.1.1', 'numpy', 'scipy>=1.2.0', 'reboundx>=3.1.0', 'rebound>=4.0.1', 'mpmath>=1.0.0']
    try:
...
setup(name='celmech',
    ...
    packages=['celmech'],
    install_requires=['exoplanet-core==0.3.0rc2','pytensor', 'mpmath>=1.0.0', 'sympy>=1.1.1', 'rebound>=4.0.1', 'reboundx>=3.1.0', 'numpy', 'scipy>=1.2.0'],
