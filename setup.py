...
try:
    ...
    ghash_arg = "-DCELMECHGITHASH=39f3688cfd5b7e05f7f0cc05ca8bf9d6b3de8543" #GITHASHAUTOUPDATE
...
if not os.getenv('READTHEDOCS'):
    packages = ['sympy>=1.1.1', 'numpy', 'scipy>=1.2.0', 'reboundx>=3.1.0', 'rebound>=3.5.11', 'mpmath>=1.0.0']
    try:
...
setup(name='celmech',
    ...
    packages=['celmech'],
    install_requires=['mpmath>=1.0.0', 'sympy>=1.1.1', 'rebound>=3.5.11', 'reboundx>=3.1.0', 'numpy', 'scipy>=1.2.0'],
