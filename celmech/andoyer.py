...
class Andoyer(object):
    ...
    def to_Poincare(self):
        ...
        p1 = PoincareParticle(m=p['m1'], sLambda=sLambda1, l=self.lambda1, sGamma=sGamma1, gamma=gamma1, Mstar=p['Mstar'], sQ=0, q=0)
        p2 = PoincareParticle(m=p['m2'], sLambda=sLambda2, l=self.lambda2, sGamma=sGamma2, gamma=gamma2, Mstar=p['Mstar'], sQ=0, q=0)
        pvars = Poincare(p['G'], [p1,p2])
